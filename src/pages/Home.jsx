          ...
          <div className="grid md:grid-cols-2 gap-5 md:gap-10">
            ...
            <div data-aos="fade-right" className="flex flex-col gap-5">
              ...
              <p className="description">
                At Softfactory, we are at the forefront of revolutionizing the
                ...
                <br /> At Softfactory, we are at the forefront of AI innovation,
      ...
      {/* <section className="wrapper">
        <div className="max-w-7xl mx-auto grid md:grid-cols-[15%_auto] items-center gap-7 pt-[5rem] pb-[3rem]">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="description">
              At Softfactory, we leverage the power of AI to create
