...
export const InquiryForm = () => {
  ...
  return (
    <div data-aos="fade-left" className="flex flex-col items-start gap-3 group">
      <p className="text-xl text-center text-secondary uppercase">Let's connect</p>
      <div className="rounded-xl relative">
        <div className="absolute -right-8 -top-8 sm:h-1/2 h-[10rem] w-[10rem] sm:w-1/2 bg-primary blur-[30px] -z-10"></div>
        <div className="absolute -left-8 -bottom-8 sm:h-1/2 h-[10rem] w-[10rem] sm:w-1/2 bg-blue-400 blur-[30px] -z-10"></div>
        <div className="bg-[#252525] p-7 w-fit rounded-lg">
          ...
          >
            ...
            <button
              ...
              className="mt-4 bg-background border border-white/30 text-black px-5 py-3 rounded-full hover:bg-black hover:text-white hover:-translate-y-1 duration-300 transition-all"
            >
              Send Message
            </button>
          </form>
